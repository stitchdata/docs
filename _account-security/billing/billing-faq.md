...
# -------------------------- #
  ...
  - topic: "Integrations"
    ...
    items:
      ...
      - question: "What integrations are available on an {{ site.data.stitch.subscription-plans.unlimited.name }} or {{ site.data.stitch.subscription-plans.unlimited-plus.name }} Plan?"
        anchor: "integrations-unlimited-plan"
        answer: |
          {% assign all-integrations = site.documents | where:"input", true %}
          {% assign unlimited-integrations = all-integrations | where:"minimum-plan","unlimited" %}
          ...
          <table class="attribute-list">
          {% for integration in unlimited-integrations %}
