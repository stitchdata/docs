    ...
    subsections:
      ...
      - title: "Connectivity"
        ...
        content: |
          ...
          - **For {{ site.data.stitch.subscription-plans.pro-plus.name }} plans**, additional [advanced connectivity options]({{ link.security.encryption | prepend: site.baseurl | append: "#advanced-connectivity" }}) - such as VPNs, reverse SSH tunneling, and Amazon Web Services Private Link - may be available.
