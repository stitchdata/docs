---
title: Amazon Aurora MySQL RDS (v2)
...
requirements-list:
  ...
  - item: |
      **A database that uses the InnoDB storage engine.** Stitch's {{ integration.display_name }} integration doesn't support databases build with the MyISAM engine.
