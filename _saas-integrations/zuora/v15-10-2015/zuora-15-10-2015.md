...
api: |
  [{{ integration.display_name }} SOAP API](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/AB_Getting_started_with_the__SOAP_API/B_Zuora_WSDL){:target="new"}
