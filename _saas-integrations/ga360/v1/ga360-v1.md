...
replication sections:  
  - title: "{{ integration.display_name }} Table Replication"
    anchor: "table-replication"
    content: |
      While Stitch's {{ integration.display_name }} replicates the full tables, tables are updated by the `ga_sessions_YYYYMMDD` bookmark value. This value is a non-field key provided by Google and they update it three times per day. Allow 24 hours to see up-to-date data in Stitch.
