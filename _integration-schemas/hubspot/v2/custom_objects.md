...
description: | 
  Tables for custom CRM objects in your {{ integration.display_name }} account will have the same name as the object. For example, if you have a custom object named `cars`, the table will be named `cars`.
