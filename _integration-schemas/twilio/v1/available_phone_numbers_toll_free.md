...
description: |
  The **{{ table.name }}** table returns a list of available toll free phone numbers for your {{ integration.display_name }} account.

replication-method: "Full Table"

api-method:
    name: "Read multiple AvailablePhoneNumberTollFree resources"
    doc-link: "https://www.twilio.com/docs/phone-numbers/api/availablephonenumber-tollfree-resource?code-sample=code-find-any-toll-free-number&code-language=curl&code-sdk-version=json"
