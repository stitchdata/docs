...
description: |
  The **{{ table.name }}** table returns a list of available phone numbers for mobile resources for your {{ integration.display_name }} account.

replication-method: "Full Table"

api-method:
    name: "Read multiple AvailablePhoneNumberMobile resources"
    doc-link: "https://www.twilio.com/docs/phone-numbers/api/availablephonenumber-mobile-resource?code-sample=code-find-mobile-numbers-by-region&code-language=curl&code-sdk-version=json"
