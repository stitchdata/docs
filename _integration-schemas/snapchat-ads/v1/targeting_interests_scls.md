...
description: "This stream retrieves the list of Snap Lifestyle Categories targeting options by the specified country code"
...
attributes:
  ...
  - name: "id"
    primary-key: true
    type: "string"
    description: "Id of scls interest"

  - name: "name"
    type: "string"
    description: "Name of the scls interest"
  ...
  - name: "targeting_type"
    type: "string"
    description: "Targeting Type. Only possible value for this stream: `scls`"
