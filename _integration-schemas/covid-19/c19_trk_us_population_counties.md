...
description: |
  The `{{ table.name }}` table contains statistics for reporting counties in the United States.
...
attributes:
  ...
  - name: "county"
    type: "string"
    description: "The name of the county. For example: `Westchester`"
  ...
  - name: "pop_density"
    type: "number"
    description: "The population density for the county."

  - name: "population"
    type: "integer"
    description: "The total population for the county."
