...
description: |
  The `{{ table.name }}` table contains info about the tracking categories in your {{ integration.display_name }} account. Tracking categories are used to track the performance of different areas of a business.
