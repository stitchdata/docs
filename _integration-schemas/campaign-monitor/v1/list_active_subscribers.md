...
doc-link: https://www.campaignmonitor.com/api/lists/#active-subscribers
...
description: |
  The `{{ table.name }}` table contains info about the active subscribers for lists.

replication-method: "Key-based Incremental"

api-method:
  name: "Get list active subscribers"
  doc-link: "https://www.campaignmonitor.com/api/lists/#active-subscribers"
