    ...
    subsections:
      - title: "Replication Frequency"
        ...
        content: |
          ...
          {% capture code %}curl -X {{ site.data.connect.core-objects.sources.update.method | upcase }} {{ site.data.connect.core-objects.sources.update.name | flatify | replace: "{source_id","86741" | remove: right-bracket | prepend: site.data.connect.api.base-url | strip_newlines  }} \
          ...
          {% assign description = "PUT " | append: site.data.connect.core-objects.sources.update.name %}
      ...
      - title: "Anchor Scheduling"
        ...
        content: |
          ...
          {% capture code %}curl -X {{ site.data.connect.core-objects.sources.update.method | upcase }} {{ site.data.connect.core-objects.sources.update.name | flatify | replace: "{source_id","77234" | remove: right-bracket | prepend: site.data.connect.api.base-url | strip_newlines  }} \
               -H 'Authorization: Bearer <ACCESS_TOKEN>' \
               -H 'Content-Type: application/json' \
               -d '{
      ...
      - title: "Advanced Scheduling using cron"
        ...
        content: |
          ...
          {% capture code %}curl -X {{ site.data.connect.core-objects.sources.update.method | upcase }} {{ site.data.connect.core-objects.sources.update.name | flatify | replace: "{source_id","12345" | remove: right-bracket | prepend: site.data.connect.api.base-url | strip_newlines  }} \
               -H 'Authorization: Bearer <ACCESS_TOKEN>' \
               -H 'Content-Type: application/json' \
               -d '{
                     "display_name":"MySQL",
