...
- [Logical replication support]({{ site.data.urls.replication.log-based-incremental | prepend: site.baseurl }}), which allows you to replicate data from database binary logs, including hard deletes, without the use of a Replication Key
